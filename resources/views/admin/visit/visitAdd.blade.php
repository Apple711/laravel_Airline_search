        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <div class="box box-info">
                    ...
                    <form class="form-horizontal" id="role_form" name="role_form" action="{{url('admin/visit')}}" method="post">
                        {{ csrf_field() }}
                        <div class="box-body">
                            <div class="form-group custom_input">
                                <label class="col-sm-2 control-label">REPORT OWNER<span class="required">*</span></label>
                                <div class="col-xs-4">
                                    <input class="form-control" name="report_owner" type="text" value="" required>
                                </div>
                            </div>
                            <div class="form-group custom_input">
                                <label class="col-sm-2 control-label">ATTENDESS<span class="required">*</span></label>
                                <div class="col-xs-4">
                                    <input class="form-control" name="attendess" type="text" value="" required>
                                </div>
                            </div>
